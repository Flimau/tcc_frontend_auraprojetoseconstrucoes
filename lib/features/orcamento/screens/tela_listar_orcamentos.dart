...
class TelaListarOrcamentos extends StatelessWidget {
  const TelaListarOrcamentos({super.key});
                  ...
                  Expanded(
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        final orcamento = controller.resultados[index];
                        return Card(
                          child: ListTile(
                            title: Text(orcamento.descritivo),
                            subtitle: Text('Tipo: ${orcamento.tipo}'),
                            trailing: IconButton(
                              icon: const Icon(Icons.edit),
                              onPressed: () {
                                // Aqui futuramente pode passar o ID para edição
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder:
                                        (_) => const TelaCadastroOrcamento(),
                                  ),
                                );
                              },
                            ),
